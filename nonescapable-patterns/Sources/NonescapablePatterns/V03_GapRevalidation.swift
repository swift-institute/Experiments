...
//
// Origin: nonescapable-gap-revalidation-624

enum V03_GapRevalidation {
    ...
    // COMPILE ERROR (expected): invalid lifetime dependence on Escapable value with consuming ownership
    ...
    // COMPILE ERROR (expected): lifetime-dependent variable 'ne' escapes its scope
    // static func testGapB() {
    //     var x = 42
