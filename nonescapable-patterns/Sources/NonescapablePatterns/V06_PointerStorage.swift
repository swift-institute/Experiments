...
// Date: 2026-03-02
//
// Origin: pointer-nonescapable-storage

enum V06_PointerStorage {
    ...
    // COMPILE ERROR (expected): type 'Element' does not conform to protocol 'Escapable'
    ...
    // COMPILE ERROR (expected): T requires Escapable
    // static func testV2b() {
    ...
    // COMPILE ERROR (expected): Element does not accept ~Escapable
    // ========================================================================
    ...
    // COMPILE ERROR (expected): "lifetime-dependent variable 'self' escapes its scope"
    // ========================================================================
    ...
    // COMPILE ERROR (expected): Same as V6 — Optional<Element> slot triggers lifetime escape
    // ========================================================================
    ...
    // COMPILE ERROR (expected): Same as V6/V8 — Optional<Element> slot triggers lifetime escape
    // ========================================================================
    ...
    // COMPILE ERROR (expected): Raw pointer typed access methods require Escapable
    // extension RawLayoutStorage {
    //     mutating func initialize(at index: Int, to value: consuming Element) {
    //         // rawPtr.initializeMemory(as: Element.self, to: value) — BLOCKED
    //         // rawPtr.assumingMemoryBound(to: Element.self) — BLOCKED
    //     }
    // }
