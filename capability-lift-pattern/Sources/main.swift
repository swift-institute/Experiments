...
//
// Mirrors Identity_Primitives.Tagged closely enough to demonstrate the
// forwarding patterns. Identity_Primitives is not imported because the
...
// matching the production Identity_Primitives.Tagged convention.
