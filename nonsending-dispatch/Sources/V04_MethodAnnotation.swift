// V04: Nonsending Method Annotation Validation
//
...
//   T4: flatMap isolation
//   T5: Non-Sendable Value
//   T6: Double-nonsending pattern (withDependencies-style)
//   T7: sending parameter with nonisolated(nonsending) function
//
// Revalidation: Re-run if #isolation or callAsFunction dispatch changes.
//
// Origin: nonsending-method-annotation
// Date: 2026-03-22
...
enum V04_MethodAnnotation {
    ...
    nonisolated(nonsending)
    static func withScope<T, E: Error>(
        _ modify: () -> Void,
